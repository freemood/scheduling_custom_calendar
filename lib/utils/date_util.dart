...
class DateUtil {
  ...
  static String getNowDateStr( {DateTime dateTime,DateFormat format = DateFormat.NORMAL}) {
    return getDateStrByDateTime(DateTime.now(),format: format);
  }
...
//   static Widget selectDate(BuildContext context, String dateTimeValue,
//       {Function stateCallback, String type: 'day'}) {
//     return FlatButton(
//       onPressed: () {
...
//            dateFormat: type == 'day' ? 'yyyy,MM,dd' : 'yyyy,MM',
...
//              ..write(date.day);
//          } else if (type == 'month') {
//            stringBuffer..write(date.year)..write('-')..write(date.month);
//          }
...
//         child: Text(
//           null == dateTimeValue || dateTimeValue.isEmpty
//               ? '请选择'
//               : dateTimeValue,
//           softWrap: false,
//           style: TextStyle(

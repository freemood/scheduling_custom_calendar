...
class Utils {
  ...
  static final DateFormat _monthCityFormat = new DateFormat("yyyy年MM月");
  static final DateFormat _dayFormat = new DateFormat("dd");
  static final DateFormat _yearOneFormat = new DateFormat("yyyy");
  static final DateFormat _monthOneFormat = new DateFormat("MM");
  ...
  static final DateFormat _apiDayFormat = new DateFormat("yyyy-MM-dd");
    static final DateFormat _monthAndDayFormat = new DateFormat("yyyy-MM");
  static final DateFormat _monthDayFormat = new DateFormat("MM.dd");

  static String formatMonth(DateTime d) => _monthCityFormat.format(d);
  static String formatMonthAndDay(DateTime d) => _monthAndDayFormat.format(d);
  static String formatDay(DateTime d) => _dayFormat.format(d);
  static String formatOneYear(DateTime d) => _yearOneFormat.format(d);
  static String formatOneMonth(DateTime d) => _monthOneFormat.format(d);
  static String formatFirstDay(DateTime d) => _firstDayFormat.format(d);
  static String fullDayFormat(DateTime d) => _fullDayFormat.format(d);
  static String apiDayFormat(DateTime d) => _apiDayFormat.format(d);
  static String formatMonthDayFormat(DateTime d) => _monthDayFormat.format(d);
  ...
  static List<DateTime> daysInMonth(DateTime month) {
    ...
    // LogUtil.e(firstToDisplay,tag: 'daysInMonth............');
    if (firstToDisplay.toString().contains('2019-11-24')) {
